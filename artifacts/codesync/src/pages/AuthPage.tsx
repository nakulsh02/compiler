      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">
            {mode === 'signin' ? 'Sign in to continue coding together' : 'Create your account to start collaborating'}
          </p>
        </div>
          ...
          <div className="mt-6 text-center">
            {mode === 'signin' ? (
              <p className="text-sm text-slate-500">
                ...
                <button onClick={() => { setMode('signup'); setError(null); }} className="text-cyan-400 hover:text-cyan-300 font-medium transition-colors">
                  Sign up
                </button>
              </p>
            ) : (
              <p className="text-sm text-slate-500">
                ...
                <button onClick={() => { setMode('signin'); setError(null); }} className="text-cyan-400 hover:text-cyan-300 font-medium transition-colors">
                  Sign in
                </button>
              </p>
            )}
